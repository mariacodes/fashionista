...
export class ProductCreateComponent implements OnInit {
  ...
  onSubmit() {
    const product = new Product(this.productForm.value['name'], this.productForm.value['brand'], this.productForm.value['price'], this.productForm.value['email'], this.productForm.value['avaibility'], this.productForm.value['fashionimage']);
  ...
  private initForm() {
    this.productForm = new FormGroup({
      ...
      avaibility: new FormControl(this.avaibility, Validators.required),
      fashionimage: new FormControl(this.fashionimage, Validators.required)
